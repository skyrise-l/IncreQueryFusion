...
class DataProcessor:
    ...
    def __init__(
        ...
        *,
        ...
        self.columns_to_embed = ["Open price", "Symbol", ""]
    ...
    def _infer_column_type(self, s: pd.Series) -> str:
        ...
        # 1. 主键列识别
        if name in {'isbn', 'id', 'symbol'} or self._is_fixed_length_key(s):
...
if __name__ == '__main__':
    ...
    EXPECTED_SCHEMA = {
        # --- 主键 / 纯标识 ---
        "Symbol": "primary_noEmd",          # 股票代码，大小写字母，定长

        # --- 纯数值（包含百分号或千分位分隔符也按数值处理） ---
        "Change %": "numeric_string", #"general_noEmd",        # +2.03% → 2.03
        "Last trading price": "numeric_string",
        "Open price": "numeric_string",
        "Change $": "numeric_string",        # +0.62 → 0.62
        "Volume": "numeric_string",          # 125,054 → 125054
        "Today's high": "numeric_string",
        "Today's low": "numeric_string",
        "Previous close": "numeric_string",
        "52wk High": "numeric_string",
        "52wk Low": "numeric_string",
        "Shares Outstanding": "numeric_string",
        "P/E": "numeric_string",
        "Yield": "numeric_string",           # 4.75% → 4.75
        "EPS": "numeric_string",

        "Market cap": "numeric_string",       # 603.05 m / 4.88 b
        "Dividend": "numeric_string",         # $0.63
    }
    ...
    processor = DataProcessor(
        ...
        output_folder='/home/lwh/QueryFusion/data/dataset/stock/final_data_emd',
    ...
    processor.read_and_process_data(
        '/home/lwh/QueryFusion/data/dataset/stock/final_data'
    )