        ...
        try:
            with open(path, "r", encoding="utf-8", errors="ignore") as f:
                ...
                for i, raw in enumerate(f, start=-1):
                    ...
                    key_value = normalize(parts[0]).lower()  # Assuming key column is the second column
                    if not key_value:
...
def apply_insert_to_sources(sources, key_column, sid: int, data: dict, index):
    ...
    key_value = normalize(data.get(key_column, "")).lower()
    if not key_value:
        return None
...
def main():
    ...
    for i in query_truth:
        entity_ids.append(i["subquery"][0]["condition_value"].lower())  
    ...
    path = "/home/lwh/QueryFusion/preprocessing/query_truth_no_evaluate_movie.json"
...
# python result_create_movie.py --raw-data-dir /home/lwh/QueryFusion/data/dataset/movie/raw_data  --log-file /home/lwh/QueryFusion/data/dataset/movie/log_data.json  --queryjson /home/lwh/QueryFusion/data/dataset/movie/query_truth.json --key-column title